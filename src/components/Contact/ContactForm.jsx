            ...
            >
                ...
                <div className="relative h-11 w-full min-w-[200px]">
                    <select
                        ...
                        className="peer h-full w-full border-b border-blue-gray-200 bg-transparent pt-4 pb-1.5 font-sans text-sm font-normal text-blue-gray-700 outline-none transition-all placeholder-shown:border-blue-gray-200 focus:border-gray-500 focus:outline-none disabled:border-0 disabled:bg-blue-gray-50 ">
                        <option className='text-black smallHeadingFont' value="" disabled selected hidden>Select Preferred Service</option>
                        <option className='text-black' value="Logos & Marks">Logos & Marks</option>
                        <option className='text-black' value="Product Packaging">Product Packaging</option>
                        <option className='text-black' value="Visual Identity">Visual Identity</option>
                        <option className='text-black' value="Social Media Post">Social Media Post</option>
